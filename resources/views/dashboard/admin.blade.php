...
<div class="dash-shell">
    <nav class="dash-sidebar">
        <a href="#" class="dash-sidebar-item" data-target="panel-overview"><span class="icon">📈</span> System Overview</a>
        <a href="#" class="dash-sidebar-item" data-target="panel-groups"><span class="icon">👥</span> Groups</a>
        <a href="#" class="dash-sidebar-item" data-target="panel-warnings"><span class="icon">⚠️</span> Inactivity Warnings</a>
        <a href="/admin/users" class="dash-sidebar-item"><span class="icon">🔑</span> Manage Users</a>
    </nav>

...
CMD ["sh", "-c", "python3 ml_service/app.py & php artisan reverb:start --host=0.0.0.0 --port=8081 & php artisan config:clear && php artisan cache:clear && php artisan serve --host=0.0.0.0 --port=${PORT:-8080}"]
